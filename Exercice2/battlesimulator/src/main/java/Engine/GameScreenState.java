...
import regular.BattleSimulationCluster;
import regular.Team;
...
public class GameScreenState extends BaseAppState implements ScreenController {
    ...
    public void fillMyListBoxTeams() {
        // Basic image
        NiftyImage newImage = nifty.getRenderEngine().createImage(this.screen, "Assets/Interface/teapot.png",false);
    ...
    protected void initialize(Application app) {
        ...
        this.game.setupGame("/Assets/FightConfigs/Fight1/entities3D.txt", "/Assets//FightConfigs/Fight1/relations.txt", true);
