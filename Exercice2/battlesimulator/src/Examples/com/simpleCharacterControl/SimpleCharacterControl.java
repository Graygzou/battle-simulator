    ...
    public void prePhysicsTick(PhysicsSpace space, float tpf) {
        ...
        if (doMove) {
            ...
            if ((angleNormals < slopeLimitAngle && physicsClosestTets != null) || !this.isActive()) {
                ...
                this.setLinearVelocity(moveCharVec.interpolateLocal(this.getLinearVelocity(), mainWalkInterpolation));
...
//                this.setLinearVelocity(moveCharVec.setY(this.getLinearVelocity().getY()));
                this.setLinearVelocity(moveCharVec.interpolateLocal(this.getLinearVelocity(), otherWalkInterpolation));
            }
            hasMoved = true;
            hasJumped = false;
            stopTimer = 0;
